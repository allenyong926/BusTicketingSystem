...
public class DriverMenuUI extends javax.swing.JFrame {
    ...
    public DriverMenuUI() {
        ...
        p1.add("create driver", cd);
        p1.add("read driver", rd);
        p1.add("update driver", ud);
        p1.add("delete driver", dd);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Driver Operation");

        jButton1.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jButton1.setText("Create Bus Diver");
        ...
        jButton2.setText("Read Bus Driver ");
        ...
        jButton3.setText("Delete Bus Driver");
        ...
        jButton4.setText("Update Bus Driver");
        ...
        jButton5.setText("Back Main Menu");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "create driver");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "read driver");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "delete driver");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
   
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "update driver");
