 ...
 * @author ASUS
 */
public class ScheduleMenuUI extends javax.swing.JFrame {
    CreateSchedule csc;
    DeleteSchedule dsc;
    UpdateSchedule usc;

    public ScheduleMenuUI() {
        initComponents();
        setSize(850,500);
        setResizable(false);
        setTitle("KL Bus Express");
        
        csc = new CreateSchedule();
        dsc = new DeleteSchedule();
        usc = new UpdateSchedule();

        
        p1.setLayout(new CardLayout());
        p1.add("create schedule", csc);
        p1.add("delete schedule", dsc);
        p1.add("update schedule", usc);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Schedule Operation");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "delete schedule");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
   
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "update schedule");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheduleMenuUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
