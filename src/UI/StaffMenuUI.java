...
public class StaffMenuUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StaffAndMemberUI
     */
    public StaffMenuUI() {
        initComponents();
        setSize(900,550);
        ...
        p1.add("create staff", cs);
        p1.add("read staff", rs);
        p1.add("update staff", us);
        p1.add("delete staff", ds);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Staff Operation");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        c1.show(p1, "create staff");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "read staff");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "delete staff");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
   
        CardLayout c1 = (CardLayout)(p1.getLayout());
        c1.show(p1, "update staff");
